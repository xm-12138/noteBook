import{_ as e,r as i,o as t,c as o,a as l,b as n,d,e as r}from"./app-8a61c1e6.js";const p={},c={href:"https://www.notion.so/152884978dd88027be45d207651edb46?pvs=21",target:"_blank",rel:"noopener noreferrer"};function u(m,a){const s=i("ExternalLinkIcon");return t(),o("div",null,[a[1]||(a[1]=l(`<h1 id="_410wifi棒子折腾日记" tabindex="-1"><a class="header-anchor" href="#_410wifi棒子折腾日记" aria-hidden="true">#</a> 410wifi棒子折腾日记</h1><h1 id="刷机为debian系统" tabindex="-1"><a class="header-anchor" href="#刷机为debian系统" aria-hidden="true">#</a> 刷机为debian系统</h1><p>网上全是教程直接搜索就好参考以下链接</p><p>https://blog.csdn.net/qq_44774198/article/details/129812022</p><h1 id="安装docker" tabindex="-1"><a class="header-anchor" href="#安装docker" aria-hidden="true">#</a> 安装docker</h1><p>https://www.runoob.com/docker/debian-docker-install.html</p><h1 id="安装unzip" tabindex="-1"><a class="header-anchor" href="#安装unzip" aria-hidden="true">#</a> 安装unzip</h1><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">apt</span> <span class="token function">install</span> <span class="token function">unzip</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h1 id="从阿里云私有仓库拉取镜像" tabindex="-1"><a class="header-anchor" href="#从阿里云私有仓库拉取镜像" aria-hidden="true">#</a> 从阿里云私有仓库拉取镜像</h1><p>根据cpu架构不同选择不同的镜像以下是arm架构的链接</p><p>https://cr.console.aliyun.com/repository/cn-hangzhou/ximeng-images/aarch64-homeassistant/details</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">docker</span> pull homeassistant/home-assistant:stable
...
https://github.com/home-assistant/android
  ...
  <span class="token key atrule">trusted_proxies</span><span class="token punctuation">:</span>
    ...
    <span class="token punctuation">-</span> <span class="token punctuation">:</span><span class="token punctuation">:</span>1/128
     ...
     <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,39)),n("p",null,[n("a",c,[a[0]||(a[0]=d("棒子的刷机")),r(s)])])])}const h=e(p,[["render",u],["__file","HomeAssistant.html.vue"]]);export{h as default};
