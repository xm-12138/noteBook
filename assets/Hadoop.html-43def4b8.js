import{_ as s,o as n,c as e,a as t}from"./app-139acd2e.js";const o={};function p(r,a){return n(),e("div",null,a[0]||(a[0]=[t(`<h2 id="解压安装hadoop" tabindex="-1"><a class="header-anchor" href="#解压安装hadoop" aria-hidden="true">#</a> 解压安装Hadoop</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">tar</span> <span class="token parameter variable">-zxvf</span> hadoop-2.6.0.tar.gz <span class="token parameter variable">-C</span> /opt/hadoop/
