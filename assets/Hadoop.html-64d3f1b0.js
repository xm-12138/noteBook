import{_ as a,o as s,c as n,a as e}from"./app-840e8edb.js";const t={},o=e(`<h2 id="解压安装hadoop" tabindex="-1"><a class="header-anchor" href="#解压安装hadoop" aria-hidden="true">#</a> 解压安装Hadoop</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">tar</span> <span class="token parameter variable">-zxvf</span> hadoop-2.6.0.tar.gz <span class="token parameter variable">-C</span> /opt/hadoop/
